...
def exp_RoeFlux_3d(num_samples: int = 1000):
    ...
    # Alphagrad with GNN in PPO network elimination order:
    order_GNN = [128, 89, 75, 101, 23, 113, 116, 78, 141, 59, 109, 108, 106, 102, 
                 92, 32, 117, 135, 104, 56, 33, 80, 145, 138, 72, 132, 81, 74, 124, 
                 48, 43, 114, 29, 137, 26, 54, 61, 34, 24, 28, 47, 100, 25, 65, 120, 
                 38, 84, 5, 93, 121, 71, 55, 129, 96, 30, 64, 21, 110, 126, 77, 31, 
                 60, 95, 53, 22, 90, 125, 94, 91, 134, 4, 139, 133, 58, 57, 3, 105, 
                 87, 136, 82, 119, 68, 6, 39, 67, 45, 112, 9, 83, 37, 107, 46, 41, 
                 111, 10, 86, 12, 85, 36, 123, 14, 127, 97, 130, 13, 118, 19, 49, 
                 40, 66, 70, 15, 20, 88, 98, 103, 73, 8, 52, 7, 11, 115, 16, 42, 51, 
                 62, 131, 122, 143, 76, 18, 69, 79, 50, 140, 99, 35, 1, 63, 27, 2, 17, 44]
